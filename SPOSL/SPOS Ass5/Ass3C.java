...
public class Ass3C 
{
    ...
    void getProcessData(Scanner input) 
    {
        ...
        String st = "P";
        System.out.print("Enter the burst time   for Process - " + (numberOfProcess) + " : ");
        for (int i = 0; i < numberOfProcess; i++) {
            processId[i] = st.concat(Integer.toString(i));
            burstTime[i] = input.nextInt();
        }
        System.out.print("Enter the arrival time for Process - " + (numberOfProcess) + " : ");
        for (int i = 0; i < numberOfProcess; i++) {
            arrivalTime[i] = input.nextInt();
        }
        System.out.print("Enter the priority for Process - " + (numberOfProcess) + " : ");
        for (int i = 0; i < numberOfProcess; i++) {
